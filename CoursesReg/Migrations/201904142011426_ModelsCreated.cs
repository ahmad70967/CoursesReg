namespace CoursesReg.Migrations
{
    ...
    public partial class ModelsCreated : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AdmissionTermCode = c.String(),
                        DateOfBirth = c.DateTime(nullable: false),
                        MajorId = c.Byte(nullable: false),
                        AddmissionCode_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AddmissionCodes", t => t.AddmissionCode_Id)
                .ForeignKey("dbo.Majors", t => t.MajorId, cascadeDelete: true)
                .Index(t => t.MajorId)
                .Index(t => t.AddmissionCode_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Students", "AddmissionCode_Id", "dbo.AddmissionCodes");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Students", new[] { "AddmissionCode_Id" });
